...
wget raw.githubusercontent.com/$nama/xnew/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -O /usr/bin/ws "https://raw.githubusercontent.com/RyyStore/x2621/main/files/ws" >/dev/null 2>&1
wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/RyyStore/x2621/main/config/tun.conf" >/dev/null 2>&1
wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/RyyStore/x2621/main/files/ws.service" >/dev/null 2>&1
